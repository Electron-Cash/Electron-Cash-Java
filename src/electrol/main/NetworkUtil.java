...
public class NetworkUtil {
	...
	public static void init_header_file(Network1 network, Blockchain b) throws JSONException {
	...
	public static JSONArray read_recent_servers() throws JSONException {
